import{_ as f,u as y,M as b,c as l,r as w,a as d,b as a,d as i,e as _,F as j,o as m}from"./index-CzRO4ZVE.js";const g="/assets/icf-credential-AJxZvstd.png",p="/assets/gtci-graduation-CJIluMDt.png",h="/assets/systemic-team-coaching-ClOepqur.png",I=`## Individualus koučingas​
...
The process of working with a specific team is tailored to the team’s needs and objectives.`,J={id:"services"},S={class:"individual"},T=["innerHTML"],L=["src"],H={class:"team"},B=["innerHTML"],D=["src"],E=["src"],F=["src"],W={__name:"ServicesSection",setup(Y){const{locale:t}=y(),o=b(),v=l(()=>o.render(t.value==="lt"?I:C)),k=l(()=>o.render(t.value==="lt"?x:M)),s=w(!1);let r=null;const n=c=>{r=c,s.value=!0};return(c,e)=>(m(),d(j,null,[a("section",J,[a("article",S,[a("aside",{innerHTML:v.value},null,8,T),a("img",{src:i(g),alt:"icf certificate",onClick:e[0]||(e[0]=u=>n(i(g)))},null,8,L)]),e[4]||(e[4]=a("hr",null,null,-1)),a("article",H,[a("aside",{innerHTML:k.value},null,8,B),a("img",{src:i(p),alt:"gtci graduation certificate",onClick:e[1]||(e[1]=u=>n(i(p)))},null,8,D),a("img",{src:i(h),alt:"systematic team coaching graduation certificate",onClick:e[2]||(e[2]=u=>n(i(h)))},null,8,E)])]),s.value?(m(),d("div",{key:0,id:"full-size",onMousedown:e[3]||(e[3]=()=>s.value=!1)},[a("img",{src:i(r),alt:"image"},null,8,F)],32)):_("",!0)],64))}},q=f(W,[["__scopeId","data-v-bcfc3d69"]]);export{q as default};
