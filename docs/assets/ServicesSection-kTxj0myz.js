...
The process of working with a specific team is tailored to the team’s needs and objectives.`,J={id:"services"},S={class:"individual"},T=["innerHTML"],L=["src"],H={class:"team"},B=["innerHTML"],D=["src"],E=["src"],F=["src"],W={__name:"ServicesSection",setup(Y){const{locale:t}=y(),o=b(),k=l(()=>o.render(t.value==="lt"?I:C)),v=l(()=>o.render(t.value==="lt"?x:M)),n=w(!1);let r=null;const s=c=>{r=c,n.value=!0};return(c,e)=>(m(),d(j,null,[a("section",J,[a("article",S,[a("aside",{innerHTML:k.value},null,8,T),a("img",{src:i(g),alt:"icf certificate",onClick:e[0]||(e[0]=u=>s(i(g)))},null,8,L)]),e[4]||(e[4]=a("hr",null,null,-1)),a("article",H,[a("aside",{innerHTML:v.value},null,8,B),a("img",{src:i(h),alt:"gtci graduation certificate",onClick:e[1]||(e[1]=u=>s(i(h)))},null,8,D),a("img",{src:i(p),alt:"systematic team coaching graduation certificate",onClick:e[2]||(e[2]=u=>s(i(p)))},null,8,E)])]),n.value?(m(),d("div",{key:0,id:"full-size",onMousedown:e[3]||(e[3]=()=>n.value=!1)},[a("img",{src:i(r),alt:"image"},null,8,F)],32)):_("",!0)],64))}},q=f(W,[["__scopeId","data-v-bcfc3d69"]]);export{q as default};
