import{_ as f,u as y,M as b,c as l,r as w,a as d,b as a,d as i,e as _,F as j,o as m}from"./index-CsLsKuAD.js";const g="/coaching-by-kristina/assets/icf-credential-AJxZvstd.png",h="/coaching-by-kristina/assets/gtci-graduation-CJIluMDt.png",p="/coaching-by-kristina/assets/systemic-team-coaching-ClOepqur.png",I=`## Individualus koučingas​
...
- Jeigu norite geriau suprasti save, geriau jaustis darbe, kryptingai planuoti karjerą.`,C=`## Individual coaching
...
If you‘d like to find more about the benefits of coaching, you might find this article helpful. [7 Benefits of Having a Coach- ICF Experience Coaching](https://experiencecoaching.com/catalysts-of-change-7-benefits-of-having-a-coach/)`,x=`## Darbas su komandomis
...
Darbo su konkrečia komanda procesas yra derinamas atsižvelgiant į komandos poreikius ir keliamus tikslus.`,M=`## Team coaching
...
The process of working with a specific team is tailored to the team’s needs and objectives.`,J={id:"services"},S={class:"individual"},T=["innerHTML"],L=["src"],H={class:"team"},B=["src"],D=["src"],E=["innerHTML"],F=["src"],W={__name:"ServicesSection",setup(Y){const{locale:t}=y(),o=b(),k=l(()=>o.render(t.value==="lt"?I:C)),v=l(()=>o.render(t.value==="lt"?x:M)),n=w(!1);let r=null;const s=c=>{r=c,n.value=!0};return(c,e)=>(m(),d(j,null,[a("section",J,[a("article",S,[a("aside",{innerHTML:k.value},null,8,T),a("img",{src:i(g),alt:"icf certificate",onClick:e[0]||(e[0]=u=>s(i(g)))},null,8,L)]),e[4]||(e[4]=a("hr",null,null,-1)),a("article",H,[a("img",{src:i(h),alt:"gtci graduation certificate",onClick:e[1]||(e[1]=u=>s(i(h)))},null,8,B),a("img",{src:i(p),alt:"systematic team coaching graduation certificate",onClick:e[2]||(e[2]=u=>s(i(p)))},null,8,D),a("aside",{innerHTML:v.value},null,8,E)])]),n.value?(m(),d("div",{key:0,id:"full-size",onMousedown:e[3]||(e[3]=()=>n.value=!1)},[a("img",{src:i(r),alt:"image"},null,8,F)],32)):_("",!0)],64))}},q=f(W,[["__scopeId","data-v-e46a8369"]]);export{q as default};
